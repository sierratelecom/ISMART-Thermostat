...
#if(!Opamp_TIA_1_CHECK_DEEPSLEEP_SUPPORT)
    static Opamp_TIA_1_BACKUP_STRUCT Opamp_TIA_1_backup =
    {
        0u, /* enableState */
    };
#endif /* (Opamp_TIA_1_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: Opamp_TIA_1_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Opamp_TIA_1_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
/*******************************************************************************
* Function Name: Opamp_TIA_1_Sleep
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Opamp_TIA_1_backup: The structure field 'enableState' is modified
...
{
#if(!Opamp_TIA_1_CHECK_DEEPSLEEP_SUPPORT)
    if(Opamp_TIA_1_CHECK_PWR_MODE_OFF)
    {
        Opamp_TIA_1_backup.enableState = 1u;
        Opamp_TIA_1_Stop();
    }
    else /* The component is disabled */
    {
        Opamp_TIA_1_backup.enableState = 0u;
    }
#endif /* (Opamp_TIA_1_CHECK_DEEPSLEEP_SUPPORT) */
}
...
/*******************************************************************************
* Function Name: Opamp_TIA_1_Wakeup
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Opamp_TIA_1_backup: The structure field 'enableState' is used to
...
{
#if(!Opamp_TIA_1_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != Opamp_TIA_1_backup.enableState)
    {
